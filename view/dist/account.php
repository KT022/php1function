        ...
        <div class="col-span-3">
            ...
            <div class="px-4 py-3 shadow flex items-center gap-4">
                ...
                <div>
                    ...
                    <h4 class="text-gray-800 capitalize font-medium"><?=$name_user?></h4>
                </div>
            </div>
            <!-- account profile end -->
            ...
            <div class="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
                ...
                <div class="space-y-1 pl-8">
                    ...
                    <a href="index.php?act=manage_address" class="hover:text-primary transition capitalize block">Manage address</a>
        ...
        <div class="col-span-9 grid md:grid-cols-3 gap-4 mt-6 lg:mt-0">
            ...
            <div class="shadow rounded bg-white px-4 pt-6 pb-8">
                <div class="flex justify-between items center mb-4">
                    ...
                    <a href="index.php?act=edituser" class="text-primary">Edit</a>
                </div>
                <div class="space-y-1">
                    <h4 class="text-gray-700 font-medium"><?=$name_user?></h4>
                    <p class="text-gray-800"><?=$email?></p>
                    <p class="text-gray-800">+<?=$tel_user?></p>
                </div>
            </div>
            <!-- single card end -->
            <!-- single card -->
