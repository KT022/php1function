                ...
                foreach ($category_list as $category) {
                   ...
                   $num = count_pro_by_cate($id_cate);
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="'.$name_cate.'"
                            class="text-gray-600 ml-3 cursor-pointer">'.$name_cate.'</label>
                        <div class="ml-auto text-gray-600 text-sm">('.$num[0][0].')</div>
                    </div>
                    <!-- single category end -->
                    ';
}
?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="Dominik"
                            class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                        <label for="Dominik"
                            class="text-gray-600 ml-3 cursor-pointer">Dominik</label>
    ...
    <div class="col-span-3">
        ...
        <div class="grid lg:grid-cols-2 xl:grid-cols-3 sm:grid-cols-2 gap-6">
            <?php
foreach ($product_list_all as $product) {
    extract($product);
