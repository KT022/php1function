...
if (strlen($detail) > 200) {
    $detail_pro_short = substr($detail, 0, 100) . '...';
}
echo '
<!-- breadcrum -->
<div class="py-4 container flex gap-3 items-center">
        ...
        <a href="index.php?act=shop" class="text-primary text-base font-medium uppercase">
            Shop
        </a>
        <span class="text-sm text-gray-400"><i class="fas fa-chevron-right"></i></span>
        <p class="text-gray-600 font-medium uppercase">' . $name_pro_short . '</p>
    </div>
    <!-- breadcrum end -->
    ...
    <div class="container pt-4 pb-6 grid lg:grid-cols-2 gap-6">
        ...
        <div>
            <div>
                <img id="main-img" src="' . $img_path . $img_pro . '" class="w-full max-h-96">
            </div>
            <div class="grid grid-cols-5 gap-4 mt-4">
                <div>
                    <img src="' . $img_path . $img_pro . '" class="max-h-28 single-img w-full cursor-pointer border">
                </div>
                <div>
                    <img src="' . $img_path . $img_pro . '" class="max-h-28 single-img w-full cursor-pointer border border-primary">
                </div>
                <div>
                    <img src="' . $img_path . $img_pro . '" class="max-h-28 single-img w-full cursor-pointer border">
                </div>
        ...
        <!-- product content -->
        <div>
            <h2 class="md:text-3xl text-2xl font-medium uppercase mb-2">' . $name_pro . '</h2>
            ...
            <div class="space-y-2">
                ...
                <p class="space-x-2">
                    ...
                    <span class="text-gray-600">' . $name_cate . '</span>
                </p>
                <p class="space-x-2">
            ...
            <div class="mt-4 flex items-baseline gap-3">
                <span class="text-primary font-semibold text-xl">$' . $pr1 . '</span>
                <span class="text-gray-500 text-base line-through">' . $dls . $pr2 . '</span>
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300 w-max">
                    ...
                    <div class="h-8 w-10 flex items-center justify-center">0</div>
                    <div class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none">+</div>
                </div>
            </div>
            <!-- color end -->
...
<div class="container pb-16">
    ...
    <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
        <?php
        foreach ($product_samecate as $product_same) {
            extract($product_same);
            if (strlen($name_pro) > 20) {
                $name_pro_short = substr($name_pro, 0, 18) . '...';
            }
            $pr11 = ($price_sale != '') ? $price_sale : $price;
            $pr22 = ($price_sale != '') ? $price : '';
            $dlss = ($pr22 != '') ? '$' : '';
            echo
            '
         <!-- single product -->
          <div class="group rounded bg-white shadow overflow-hidden">
              <!-- product image -->
              <div class="relative">
                  <img src="' . $img_path . $img_pro . '" class="w-full max-h-56">
              ...
              <div class="pt-4 pb-3 px-4">
                  ...
                  <div class="flex items-baseline mb-1 space-x-2">
                      <p class="text-xl text-primary font-roboto font-semibold">$' . $pr11 . '</p>
                      <p class="text-sm text-gray-400 font-roboto line-through">' . $dlss . $pr22 . '</p>
                  </div>
