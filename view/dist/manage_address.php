                ...
                <div class="space-y-4">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input class="input-box" type="text" name="country" placeholder="UNITED KINGDOM">
                        </div>
                        <div>
                            <label class="text-gray-600 mb-2 block">
                                City
                            ...
                            <input class="input-box" type="text" name="city" placeholder="PORTSMOUTH">
                        </div>
                    </div>
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input class="input-box" type="text" name="district" value="" placeholder="Fratton">
                        </div>
                        <div>
                            <label class="text-gray-600 mb-2 block">
                                Street Number/Name
                            ...
                            <input class="input-box" type="text" name="street" value="" placeholder="30 Commercial Road">
                        </div>
                    </div>
                    <div>
                        <label class="text-gray-600 mb-2 block">
